...
function ResendValidatoin() {
  const [email, setEmail] = useState("");
  const [message, setMessage] = useState("");

  const handleSubmit = (e) => {
    e.preventDefault();
    setMessage("Um email com as instruções para validar conta foi enviado para seu email.");
  };
      ...
      <div className="wrap-login">
        {message ? (
          ...
          <form className="login-form" onSubmit={handleSubmit}>
            <span className="login-form-title">Reenviar Validação</span>
...
export default ResendValidatoin;